...
// (PUT) /api/movielist/watchlist/:movie_id - to add a movie (by it's id) to the user's watchlist
router.put('/movielist/watchlist/:movie_id', auth, ctrl_watchlist.addMovieToWatchlist);
...
// (PUT) /api/movielist/favoritelist/:movie_id - to add a movie (by it's id) to the user's favoritelist
router.put('/movielist/favoritelist/:movie_id', auth, ctrl_watchlist.addMovieToFavoritelist);
...
// (PUT) /api/movielist/seenlist/:movie_id  - to add a movie (by it's id) to the user's seenlist
router.put('/movielist/seenlist/:movie_id', auth, ctrl_watchlist.addMovieToSeenlist);
